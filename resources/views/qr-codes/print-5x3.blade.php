...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .qr-code svg { display: block; width: 100px; height: 100px; }
        ...
        .kode-manual { font-size: 7px; font-weight: bold; text-align: center; padding: 2px; border: 1px solid #000; font-family: 'Courier New', monospace; }
