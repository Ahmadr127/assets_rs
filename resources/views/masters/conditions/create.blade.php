...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tambah Kondisi</h1>
    ...
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg p-6">
        <form action="{{ route('masters.conditions.store') }}" method="POST" class="space-y-6">
            @csrf
            <x-form.input name="name" label="Nama" required autofocus />
            <x-form.input name="slug" label="Slug" placeholder="Opsional, otomatis dari nama jika dikosongkan" />
