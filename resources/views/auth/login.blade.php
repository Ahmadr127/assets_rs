...
@section('title', 'Login - Assets System')
...
<div class="min-h-screen w-full flex">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div class="w-full max-w-md">
            ...
            <div class="lg:hidden flex flex-col items-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Assets System</h2>
                <p class="text-sm text-gray-600">Assets Management System</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="mt-6 text-center text-sm text-gray-500">
                    <p>© {{ date('Y') }} Assets System. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 via-green-700 to-green-800 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center w-full px-12 text-white">
            ...
            <!-- App Name -->
            <h1 class="text-5xl font-bold mb-4 text-center">Assets System</h1>
